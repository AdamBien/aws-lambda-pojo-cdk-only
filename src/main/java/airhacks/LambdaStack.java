...
public class LambdaStack extends Stack {
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder functionJar(String location) {
            verifyFunctionJar(location);
            this.functionJarLocation = location;
            return this;
        }        
        ...
        static boolean verifyFunctionJar(String functionZipFile) {
            if (!functionZipFile.endsWith("function.jar")) {
            ...
            if (!exists) {
                throw new IllegalArgumentException("function.jar not found at: " + functionZipFile);
            }
            return true;
        }
    ...
    public LambdaStack(Builder builder) {
        ...
        var function = createFunction(builder.functionJarLocation,builder.functionName, builder.functionHandler, builder.configuration, builder.ram, timeout);
